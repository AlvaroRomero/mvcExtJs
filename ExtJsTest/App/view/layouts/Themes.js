Ext.define('MiMvc5.view.layouts.Themes', {
	...
	*/
	...
	var items = [
		this.getBasicPanel(rtl),
		this.getCollapsedPanel(rtl),
		maskedPanel = this.getMaskedPanel(rtl),
		this.getFramedPanel(rtl),
		this.getCollapsedFramedPanel(rtl),
		this.getBasicWindow(rtl),
		this.getPanelWithToolbars(rtl),
		this.getFormWidgets(rtl),
		this.getBorderLayout(rtl),
		this.getGrid(rtl),
		this.getAccordion(rtl),
		this.getScrollingTabs(rtl),
		this.getPlainTabs(rtl),
		this.getDatePicker(rtl),
		this.getProgressBar(rtl),
		this.getFramedGrid(rtl),
		this.getRibbonPanel(rtl),
		this.getPiePanel(rtl),
