Ext.onReady(function() {
		...
		if (exists('Ext.form.field.VTypes')) {
				Ext.apply(Ext.form.field.VTypes, {
						...
						alphaText: 'Este campo sólo debe contener letras y \'-\'',
						alphanumText: 'Este campo sólo debe contener letras, números y \'-\'',
						emailsText: 'Este campo debe ser una o varias direcciones de correo electrónico con el formato "usuario@dominio.com" separadas por coma',
						phonesText: 'Este campo debe ser uno o varios teléfonos separados por coma'
				});
		}
});
